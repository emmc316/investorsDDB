...
VALUES  (1,'C','NAPI990201N21',8765.00,true),
        (2,'C','NAPI990201N22',9312.00,true),
        (3,'C','NAPI990201N23',7532.00,true),
        (4,'C','NAPI990201N24',8123.00,true),
        (5,'C','NAPI990201N25',9420.00,true),
        (6,'C','NAPI990201N26',7290.00,true),
        (7,'C','NAPI990201N27',8541.00,true),
        (8,'C','NAPI990201N28',7061.00,true),
        (9,'C','NAPI990201N29',7777.00,true),
        (10,'C','NAPI990201N30',8100.00,true);
...
VALUES  (1,1,'A','2022-09-01','2023-08-31'),
        (2,2,'A','2022-09-15','2023-09-14'),
        (3,3,'A','2022-10-01','2023-09-30'),
        (4,4,'A','2022-10-15','2023-10-14'),
        (5,5,'A','2022-11-01','2023-10-31'),
        (6,6,'A','2022-11-15','2023-11-14'),
        (7,7,'A','2022-12-01','2023-11-30'),
        (8,8,'A','2022-12-15','2023-12-14'),
        (9,9,'A','2023-01-01','2023-12-31'),
        (10,10,'A','2023-01-15','2024-01-14'),
        (11,7,'A','2023-02-01','2024-01-31'),
        (12,1,'A','2023-02-15','2024-02-14'),
        (13,4,'A','2023-03-01','2024-02-29'),
        (14,5,'A','2023-03-15','2024-03-14'),
        (15,1,'A','2023-04-01','2024-03-31');

DROP USER IF EXISTS nodoRC;
CREATE USER 'nodoRC'@'%' identified by '1234';
GRANT ALL PRIVILEGES ON inversionesr.* TO 'nodoRC'@'%';
FLUSH PRIVILEGES;
